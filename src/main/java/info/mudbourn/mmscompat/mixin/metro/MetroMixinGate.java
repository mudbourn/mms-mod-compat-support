...
/**
 * Gates the ModMetro speed-awareness mixin on BOTH mods being loaded.
 * Without ACE there is no speed mismatch and the patch should stay inert.
 */
public class MetroMixinGate implements IMixinConfigPlugin {

    private final boolean present =
            FabricLoader.getInstance().isModLoaded("modmetro")
                    && FabricLoader.getInstance().isModLoaded("audaki_cart_engine");
