...
/**
 * Gates the Aerial Hell mixins on the mod being loaded.
 * Without this guard, the mixins would error on servers/clients
 * that don't have Aerial Hell installed.
 */
public class AerialHellMixinGate implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("aerialhell");
