...
/**
 * Gates the Apoli armor null-guard mixin on apoli-legacy being loaded.
 */
public class ApoliMixinGate implements IMixinConfigPlugin {

    private final boolean present =
        FabricLoader.getInstance().isModLoaded("apoli-legacy");
