...
/**
 * Gates the ComputerPC display-culling patches on ComputerPC being loaded.
 */
public class ComputerpcMixinGate implements IMixinConfigPlugin {

    private final boolean present =
        FabricLoader.getInstance().isModLoaded("computerpc");
