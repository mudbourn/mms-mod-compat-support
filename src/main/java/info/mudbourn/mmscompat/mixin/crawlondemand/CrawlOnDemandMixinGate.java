...
/**
 * Gates the Crawl on Demand start-condition patch on that mod being loaded.
 */
public class CrawlOnDemandMixinGate implements IMixinConfigPlugin {

    private final boolean present =
        FabricLoader.getInstance().isModLoaded("crawlondemand");
