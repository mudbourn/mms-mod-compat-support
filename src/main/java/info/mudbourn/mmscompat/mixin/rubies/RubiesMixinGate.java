...
/**
 * Gates the Rubies mixin on the mod being loaded.
 * Without this guard, the mixin would error on servers/clients
 * that don't have Rubies installed.
 */
public class RubiesMixinGate implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("rubies");
