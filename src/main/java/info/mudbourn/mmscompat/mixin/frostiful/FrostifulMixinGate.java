...
/**
 * Gates the Frostiful mixins on the mod being loaded, so clients and servers
 * without Frostiful do not error on a missing target class.
 */
public class FrostifulMixinGate implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("frostiful");
