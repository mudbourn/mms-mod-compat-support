...
/**
 * Gates JEG mixins on the mod being loaded.
 */
public class JegMixinPlugin implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("jeg");
