...
public class MmsModCompatSupport implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        LOG.info("MMS Mod Compat Support v0.6.4 loaded — creative-tab dedup, REI null-filter fix, AR item-drop suppression, creative embargo, /vanity, Jobs+ XP cooldown, warrior job, Xaero chunk sync.");
    }
